        ...
        <div className="flex flex-col items-start gap-[24px] w-full">
          ...
          <div className="flex flex-row items-start gap-[24px] ">
            <div className=" flex flex-col justify-center items-start gap-[12px] w-[440px] ">
              ...
              <input maxLength={10} minLength={10} type="number" name="phone" placeholder="Phone"  className="text-black pl-4 w-[440px] h-[50px] border-[1px] border-[solid] border-[#E4E4E4] rounded-[16px]"/>
            </div>
            <div className=" flex flex-col justify-center items-start gap-[12px] w-[440px] ">
              <label htmlFor="Address" className="text-black"> Address (optional)</label>
              <input name="Address" placeholder="Address" className="text-black pl-4 w-[440px] h-[50px] border-[1px] border-[solid] border-[#E4E4E4] rounded-[16px]"/>
            </div>
          </div>
        </div>
