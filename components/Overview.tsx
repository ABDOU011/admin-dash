...
import {  monthchart, newUsers, usersCount, history } from "@/app/protected/users/actions/actions";
...
export default function Overview({}: {}) {
  ...
  histo?.forEach((item: { admin_name: any; name: any; created_at: any; }) => {
    ...
    <div className="flex flex-col items-center pt-0 px-[24px] pb-[80px] gap-[24px] w-full">
      ...
      <div className="flex flex-row items-start px-[32px] py-[24px] gap-[64px] bg-[#FFFFFF] border-[1px] border-[solid] border-[#E4E4E4] rounded-[16px]">
        <div className="flex flex-col gap-16">
          ...
          <h3 className="text-black">Month With Most Users : {xLabels[maxIndex]}</h3>
        </div>
        <LineChart
          ...
          />
            <div className="flex flex-row justify-around items-center w-full"> 
                <div className="flex flex-col ">
                    ...
                    <p className="font-bold text-[18px] text-[#1B1E28] opacity-70">63%</p>
                </div> 
                <div className="flex flex-col ">
                    <div className="flex flex-row gap-1 items-center">
                    ...
                    <p className="font-bold text-[18px] text-[#1B1E28] opacity-70">27%</p>
                </div>   
            </div>
        </div>
