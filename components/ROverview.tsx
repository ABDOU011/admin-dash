  ...
  return (
    <div className="flex flex-col items-center pt-0 px-[24px] pb-[80px] gap-[24px] w-full">
      <div className="flex flex-row items-center justify-between p-[24px] w-full">
          ...
          <button className="font-['SF_Compact_Display'] font-medium text-[20px] text-[#24BAEC] ">
            Overview
          </button>
        
        <div className="flex-row items-center p-[12px] gap-[18px] w-[110px] h-[58px] bg-[#FFFFFF] border-[1px] border-[solid] border-[#E4E4E4] [box-shadow:14px_17px_40px_4px_rgba(112,_144,_176,_0.08)] rounded-[30px]"></div>
      </div>
